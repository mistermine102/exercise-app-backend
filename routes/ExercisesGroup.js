...
router.post('/', [body('name').not().isEmpty().withMessage('Name is required.')], exercisesGroupCtrl.createExercisesGroup)
router.delete('/', exercisesGroupCtrl.removeExercisesGroup)
router.put('/', exercisesGroupCtrl.editExercisesGroup)
